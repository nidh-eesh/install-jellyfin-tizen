...
TAG_URL="${3:-https://github.com/nidh-eesh/jellyfin-tizen-builds/releases/latest}";
...
DOWNLOAD_URL=$(echo https://github.com/nidh-eesh/jellyfin-tizen-builds/releases/download/${TAG}/${JELLYFIN_BUILD_OPTION}.wgt);
